...
/**
 * Response bean for GetReadyVehiclesByCategoryAndModel API.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public record GetReadyVehiclesByCategoryAndModelResponseBean(
        @JsonProperty("result") ReadyVehiclesResult result,
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record ReadyVehiclesResult(
            @JsonProperty("items") List<ReadyVehicle> items
    ) {
    }
    
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record ReadyVehicle(
